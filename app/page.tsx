    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          <Link href="/nutrition" className="glass-card rounded-xl p-6 hover:shadow-xl transition-all hover:scale-105">
          ...
          <Link href="/exercise" className="glass-card rounded-xl p-6 hover:shadow-xl transition-all hover:scale-105">
            <div className="flex items-center justify-between mb-4">
          ...
          <Link
            href="/predictions"
            className="glass-card rounded-xl p-6 hover:shadow-xl transition-all hover:scale-105"
          >
            <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/remedies" className="glass-card rounded-xl p-6 hover:shadow-xl transition-all hover:scale-105">
            <div className="flex items-center justify-between mb-4">
